  ...
  <div class="container">
    <div class="row">
      ...
      <?php if (!empty($page['sidebar_first'])): ?>
        <aside id="sidebar_first" class="sidebar col-xs-3">
      ...
      <?php endif; ?>
      <?php if (!empty($page['sidebar_first']) && empty($page['sidebar_second']) ): ?>
        <div class="content col-xs-9 sidebar-first">
      <?php endif; ?>
      <?php if (empty($page['sidebar_first']) && !empty($page['sidebar_second']) ): ?>
        <div class="contenido caja col-xs-9 sidebar-second">
      <?php endif; ?>
          <a id="main-content"></a>
          <div class="bread-section">
            <?php if (!empty($page['bread-section'])): ?>  
              <?php print render($page['bread-section']); ?>
            <?php endif; ?>          
          </div>
      ...
      <?php if (!empty($page['sidebar_second'])): ?>
        <aside id="sidebar_second" class="sidebar col-xs-3">
